...
public class T4_cssSelector_getText {
    ...
    public static void main(String[] args) {
        ...
        String actualResetPasswordButtonText = resetPasswordButton.getText();//we used getText(); because it is between openin and closing tag
        ...
        if (actualResetPasswordButtonText.equals(expectedResetPasswordButtonText)) {
            ...
            System.err.println("'Reset password' button verification FAILED!");
        }
