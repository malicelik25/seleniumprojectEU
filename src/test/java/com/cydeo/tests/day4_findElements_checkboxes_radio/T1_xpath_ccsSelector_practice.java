...
public class T1_xpath_ccsSelector_practice {
    ...
    public static void main(String[] args) {
        ...
        //c. “E-mail” text
        WebElement e_mailLabel = driver.findElement(By.xpath("//label[@for='email']"));
        ...
        System.out.println("e_mailLabel.isDisplayed() = " + e_mailLabel.isDisplayed());
